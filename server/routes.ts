...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  const corePages: Array<{ path: string; title: string; description: string; h1: string; noindex?: boolean }> = [
    { path: '/',                 title: 'UrbanGrid Property Inspection UAE | Snagging & Inspection Services', h1: 'Property Snagging & Inspection Services in Dubai & UAE', description: 'UrbanGrid is a leading property inspection and snagging company in the UAE. We inspect homes, apartments, and villas across Dubai, Abu Dhabi, and Sharjah. Call +971 567427634 for same-day reports.', noindex: false },
    ...
    { path: '/services',         title: 'Inspection Services | Snagging & RERA | UrbanGrid UAE',              h1: 'Property Inspection & Snagging Services in the UAE',                description: 'Explore UrbanGrid\'s full range of property inspection services: new build snagging, RERA compliance, technical due diligence, and more across the UAE.', noindex: false },
